...
print(f"Relevance: {review.relevance_score}/10")
print(f"Naturalness: {review.naturalness_score}/10")
print(f"Professionalism: {review.professionalism_score}/10")
...
print()
print("=" * 80)
print("REVIEWED COVER LETTER")
print("=" * 80)
print()

final_letter = review.revised_cover_letter

print(final_letter.greeting)
print()

print(final_letter.opening)
print()

for paragraph in final_letter.body:
    print(paragraph)
    print()

print(final_letter.closing)
print()

print(final_letter.sign_off)
